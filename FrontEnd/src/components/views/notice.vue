  ...
  <v-data-table :headers="headers" :items="items" class="elevation-1">
    <template v-slot:top>
      <v-toolbar flat>
        ...
        <v-spacer></v-spacer>
        <!-- dialog의 상태에 따라 등록dialog가 뜨거나 닫혀있음 -->
        <v-dialog v-model="dialog" max-width="500px">
          <template v-slot:activator="{ on, attrs }">
            <v-btn color="primary" dark class="mb-2" v-bind="attrs" v-on="on"> 등록 </v-btn>
          </template>
          <v-card>
            <v-card-title>
        ...
        <!-- dialogDelete의 상태에 따라 삭제dialog가 뜨거나 닫혀있음 -->
        ...
        <!-- dialogDetail의 상태에 따라 상세정보dialog가 뜨거나 닫혀있음 -->
        <v-dialog v-model="dialogDetail" max-width="500px">
          <v-card>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="blue darken-1" text @click="closeDetail"> 닫기 </v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
      </v-toolbar>
